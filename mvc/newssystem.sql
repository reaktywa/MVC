...
--
-- Host: 127.0.0.1
-- Czas generowania: 10 Paź 2017, 19:52
...
INSERT INTO `users` (`userID`, `Firstname`, `Surname`, `Nick`, `Passwd`, `Category`) VALUES
(1, 'Piotr', 'Sułkowski', 'piter292922', 'lellel', 1),
(2, 'Hohol', 'Lololol', 'admin', 'admin', 1),
(3, 'Grzesiek', 'Ociepka', 'user1', 'user1', 2);
...
--
ALTER TABLE `comments`
  MODIFY `ComentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
